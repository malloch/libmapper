 ...
 *  \param names        Array of name strings, one for each new instance,
 *                      or 0 for "anonymous" instances.
 *  \param data         Array of user context pointers, one for each new instance,
 *                      or 0 if not needed.
 *  \return             Number of instances added. */
int mpr_sig_reserve_inst(mpr_sig signal, int number, mpr_id *ids, const char **names, void **data);
