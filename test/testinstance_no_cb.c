...
test_config test_configs[] = {
    ...
    {  1, SNGL, NONE, SNGL, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    {  2, SNGL, NONE, SNGL, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* singleton ==> singleton; shouldn't make a difference if map is instanced */
    {  3, SNGL, NONE, SNGL, INST, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    {  4, SNGL, NONE, SNGL, INST, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* singleton ––> instanced; control all active instances */
    {  5, SNGL, NONE, INST, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },
    {  6, SNGL, NONE, INST, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },

    /* singleton ==> instanced; control a single instance (default) */
    /* TODO: check that instance is released on map_free() */
    {  7, SNGL, NONE, INST, INST, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    {  8, SNGL, NONE, INST, INST, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* instanced ––> singleton; any source instance updates destination */
    {  9, INST, NONE, SNGL, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    /* ... but when processing @dst only the last instance update will trigger handler */
    { 10, INST, NONE, SNGL, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    ...
    { 11, INST, NONE, SNGL, INST, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    { 12, INST, NONE, SNGL, INST, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    ...
    { 13, INST, NONE, INST, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },
    { 14, INST, NONE, INST, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },

    /* instanced ==> instanced; no stealing */
    { 15, INST, NONE, INST, INST, MPR_LOC_SRC, NO_ACTION, NULL,  4.0,  4.0,  3.21, 3.21, 0.01,  0 },
    { 16, INST, NONE, INST, INST, MPR_LOC_DST, NO_ACTION, NULL,  4.0,  4.0,  3.01, 3.21, 0.01,  0 },

    /* instanced ==> instanced; steal newest instance */
    { 17, INST, NONE, INST, INST, MPR_LOC_SRC, STEAL_NEW,  NULL, 4.0,  4.0,  3.4,  3.4,  0.01,  0 },
    /* TODO: verify that shared_graph version is behaving properly */
    { 18, INST, NONE, INST, INST, MPR_LOC_DST, STEAL_NEW,  NULL, 4.0,  4.0,  3.22, 3.4,  0.01,  0 },

    /* instanced ==> instanced; steal oldest instance */
    /* TODO: document why multiplier is not 5.0 */
    { 19, INST, NONE, INST, INST, MPR_LOC_SRC, STEAL_OLD,  NULL, 4.0,  4.0,  4.0,  4.0,  0.01,  0 },
    { 20, INST, NONE, INST, INST, MPR_LOC_DST, STEAL_OLD,  NULL, 4.0,  4.0,  4.0,  4.0,  0.01,  0 },

    /* instanced ==> instanced; add instances if needed */
    { 21, INST, NONE, INST, INST, MPR_LOC_SRC, ADD_INST,  NULL,  5.0,  5.0,  4.91, 4.91, 0.01,  0 },
    { 22, INST, NONE, INST, INST, MPR_LOC_DST, ADD_INST,  NULL,  5.0,  5.0,  4.0,  4.91, 0.01,  0 },
    ...
    { 30, SNGL, SNGL, INST, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },
    ...
    { 35, INST, INST, INST, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.0,   1 },
    { 36, INST, INST, INST, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.1,   1 },

    /* instanced convergent ==> instanced */
    { 37, INST, INST, INST, INST, MPR_LOC_SRC, NO_ACTION, NULL,  4.0,  4.0,  3.21, 3.21, 0.0,   0 },
    /* when mapped in the configuration with persistent destination signal and destination-side
     * processing, reference counts for GID usage should be incremented //per slot// rather than
     * //per map// since each map source will independently release the instance (and decrement GID)
     * refcount. This is not currently handled correctly, but should be fixed when upgrading to
     * instanced object branch. */
    /* TODO: use proxy source signals at the destination to receive updates? */
    { 38, INST, INST, INST, INST, MPR_LOC_DST, NO_ACTION, NULL,  4.0,  4.0,  3.01, 3.21, 0.0,   0 },

    /* mixed convergent ––> singleton */
    /* for src processing the update count is additive since the destination has only one instance */
    { 39, SNGL, INST, SNGL, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    /* TODO: we should default to dst processing for this configuration */
    { 40, SNGL, INST, SNGL, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* mixed convergent ==> singleton */
    /* for src processing we expect one update per iteration */
    { 41, SNGL, INST, SNGL, INST, MPR_LOC_SRC, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    /* for dst processing we expect one update per iteration */
    { 42, SNGL, INST, SNGL, INST, MPR_LOC_DST, NO_ACTION, NULL,  1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* mixed convergent ––> instanced */
    { 43, SNGL, INST, INST, SNGL, MPR_LOC_SRC, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },
    /* each active instance should receive 1 update per iteration */
    { 44, SNGL, INST, INST, SNGL, MPR_LOC_DST, NO_ACTION, NULL,  2.0,  2.0,  2.0,  2.0,  0.01,  1 },

    /* mixed convergent ==> instanced */
    { 45, SNGL, INST, INST, INST, MPR_LOC_SRC, NO_ACTION, NULL,  4.0,  4.0,  3.21, 3.21, 0.01,  0 },
    { 46, SNGL, INST, INST, INST, MPR_LOC_DST, NO_ACTION, NULL,  4.0,  4.0,  3.01, 3.21, 0.01,  0 },

    /* singleton ––> instanced; in-map instance management */
    /* Should we be updating all active destination instances here? */
    { 47, SNGL, NONE, INST, SNGL, MPR_LOC_SRC, NO_ACTION, EXPR1, 1.0,  1.0,  1.0,  1.0,  0.01,  1 },
    { 48, SNGL, NONE, INST, SNGL, MPR_LOC_DST, NO_ACTION, EXPR1, 1.0,  1.0,  1.0,  1.0,  0.01,  1 },

    /* singleton ==> instanced; in-map instance management */
    { 49, SNGL, NONE, INST, INST, MPR_LOC_SRC, NO_ACTION, EXPR1, 0.5,  0.5,  0.5,  0.5,  0.01,  0 },
    { 50, SNGL, NONE, INST, INST, MPR_LOC_DST, NO_ACTION, EXPR1, 0.5,  0.5,  0.5,  0.5,  0.01,  0 },

    /* instanced ––> singleton; instance reduce expression */
    { 51, INST, NONE, SNGL, SNGL, MPR_LOC_SRC, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    { 52, INST, NONE, SNGL, SNGL, MPR_LOC_DST, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* instanced ==> singleton; instance reduce expression */
    { 53, INST, NONE, SNGL, INST, MPR_LOC_SRC, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  0 },
    { 54, INST, NONE, SNGL, INST, MPR_LOC_DST, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  0 },

    /* instanced ––> instanced; instance reduce expression */
    /* result of expression should update all active destination instances */
    { 55, INST, NONE, INST, SNGL, MPR_LOC_SRC, NO_ACTION, EXPR2, 2.0,  2.0,  2.0,  2.0,  0.01,  1 },
    { 56, INST, NONE, INST, SNGL, MPR_LOC_DST, NO_ACTION, EXPR2, 2.0,  2.0,  2.0,  2.0,  0.01,  1 },

    /* instanced ==> instanced; instance reduce expression */
    // TODO: currently each update is a new instance, should be a stream of one map-managed instance
    { 57, INST, NONE, INST, INST, MPR_LOC_SRC, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  1 },
    { 58, INST, NONE, INST, INST, MPR_LOC_DST, NO_ACTION, EXPR2, 1.0,  1.0,  1.0,  1.0,  0.01,  1 },
...
int setup_src(mpr_graph g, const char *iface)
{
    ...
    if (verbose) {
        ...
        while (sigs) {
            ...
            eprintf("Output signal '%s' added with %d instances.\n",
